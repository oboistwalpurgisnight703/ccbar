...
ඔබේ rate-සීමා කවුළු කළමනාකරණය කිරීමට උපකාරී වන අමතර කරුණු දෙකක් ඇත:
...
- **Burn-rate අනතුරු ඇඟවීම** *(opt-in)* — ඔබේ වර්තමාන වේගය සීමාවක් එය නැවත සැකසීමට *පෙර* අවසන් වන බව පුරෝකථනය කරන විට, ccbar මඟින් එම තීරුවට `⚠ <time>` ඇස්තමේන්තුවක් එක් කරයි. පෙරනිමියෙන් ක්‍රියාවිරහිතයි; `ccbar config` හිදී එය සක්‍රීය කරන්න.
...
| `CCBAR_SHOW_BURN`   | `0`     | ඔබේ වේගය සීමාවක් කලින් අවසන් කරන විට අනතුරු අඟවන්න (`⚠ <time>`) (`1`/`0`). |
