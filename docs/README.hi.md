...
नमूना डेटा के साथ स्टेटस लाइन का पूर्वावलोकन करें।
...
पक्का नहीं कि आपको कौन सा लुक चाहिए? क्यूरेटेड प्रीसेट्स का एक सेट ब्राउज़ करें — प्रत्येक थीम, बार स्टाइल और चौड़ाई का एक संयोजन — और एक ही कीस्ट्रोक में किसी एक को लागू करें:

```sh
ccbar gallery
```

यह हर प्रीसेट को नमूना डेटा के साथ रेंडर करके प्रिंट करता है, फिर (टर्मिनल में) पूछता है कि किसे लागू करना है। किसी प्रीसेट को लागू करने से केवल थीम और बार स्टाइल बदलती है — आपका org लेबल और सेगमेंट टॉगल्स बरकरार रहते हैं। बिना प्रॉम्प्ट के केवल ब्राउज़ करने के लिए इसे पाइप करके चलाएँ (जैसे `ccbar gallery | less`)।
